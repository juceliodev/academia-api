...
<p>Implementacão de uma <strong>API RESTFull</strong> desenvolvida com ênfase na modelagem de suas entidades, no domínio uma academia de ginástica</p>

<ol>
    <li> Configuração do banco de dados (SGBD <em>PostgreSQL</em>)</li>
    <li> Aplicação de <em>annotations</em></li>
...
<ul>
 ...
 [Linkedin Jucelio de sa](https://www.linkedin.com/in/juceliodesa/ "jucelio").